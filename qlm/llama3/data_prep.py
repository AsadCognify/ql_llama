...
class Data_Prep:
    ...
    @staticmethod
    # def llama3_data_preparation(system_prompt: Any, query_list: List, response_list: List, out_file_path: str):
    def llama3_data_preparation(csv_file_path: str, out_file_path: str):
        ...
        for index, row in df.iterrows():
            ...
            {row['system_prompt']} <|eot_id|><|start_header_id|>user<|end_header_id|>
